                ...
                for ( int iChange = 1; iChange <= 2; iChange++)
                {
                    ...
                    switch (iChange)
                    {
                        case 1:
                            ...
                            iDice1 = random2.Next(1, 6);
                            Console.WriteLine("Dice Rolled by {0} Number is {1}", sPlayer1, iDice1);

                            iPosition1 += iDice1;
                            Console.WriteLine(" Position is {0}", +iPosition1);

                            if (iPosition1 > 100)
                            {
                                iPosition1 = iPosition1 - iDice1;
                                Console.WriteLine("Not Valid your position is same {0}", iPosition1);
                                break;
                            ...
                            {
                                iPosition1 -= 17;
                                Console.WriteLine("You Got Sneke {0} new position is {1}", sPlayer1, iPosition1);
                            }
                            else if ((iPosition1 == 62) || (iPosition1 == 54) || (iPosition1 == 17))   // Snake
                            {
                                iPosition1 -= 9;
                                Console.WriteLine("You Got Sneke {0} new positin is {1}", sPlayer1, iPosition1);
                            }

                            else if ((iPosition1 == 4) || (iPosition1 == 9) || (iPosition1 == 51) || (iPosition1 == 40) || (iPosition1 == 63) || (iPosition1 == 51))// Ladder
                            {
                                iPosition1 += 13;
                                Console.WriteLine("You Got Ladder {1} new position is {0}", iPosition1, sPlayer1);
                        ...
                        case 2:
                            ...
                            iDice2 = random2.Next(1, 6);
                            Console.WriteLine("Dice Rolled by {0} Number is {1}", sPlayer2, iDice2);

                            iPosition2 += iDice2;
                            Console.WriteLine(" Position is {0}", iPosition2);

                            if (iPosition2 > 100)
                            {
                                iPosition2 = iPosition2 - iDice2;
                                Console.WriteLine("Not Valid  your position remain same{0}", iPosition2);
                                break;
                            ...
                            {
                                iPosition2 -= 17;
                                Console.WriteLine("You Got Sneke {1} new position is {0}", iPosition2, sPlayer2);
                            }
                            ...
                            {
                                iPosition2 += 13;
                                Console.WriteLine("You Got Ladder {1} new position is {0}", iPosition2, sPlayer2);
